      ...
      <div style={{ 
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            {['customer', 'vendor', 'affiliate'].map(type => (
              <button
                key={type}
                type="button"
          ...
          <div style={{ color: '#888', fontSize: '0.9rem', marginTop: '0.5rem' }}>
            ...
            {formData.userType === 'affiliate' && 'Earn commissions by promoting products'}
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  padding: '12px 15px',
                  borderRadius: '8px',
                  border: errors.username ? '2px solid #ff6b6b' : '2px solid #2d2d4d',
                  background: '#0f0f23',
                  color: 'white',
                  fontSize: '1rem',
                  outline: 'none',
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  padding: '12px 15px',
                  borderRadius: '8px',
                  border: errors.confirmPassword ? '2px solid #ff6b6b' : '2px solid #2d2d4d',
                  background: '#0f0f23',
                  color: 'white',
                  fontSize: '1rem',
                  outline: 'none',
              ...
              {formData.password && formData.confirmPassword && 
               formData.password === formData.confirmPassword && (
                <p style={{ color: '#00ff88', fontSize: '0.9rem', marginTop: '0.5rem' }}>
                  ✓ Passwords match
                </p>
              )}
            </div>
          ...
          <div style={{ 
            ...
            borderRadius: '8px',
            marginBottom: '1.5rem',
            border: errors.terms ? '1px solid #ff6b6b' : '1px solid #2d2d4d'
          }}>
            <div style={{ 
              display: 'flex', 
              ...
              />
              <div>
                <label htmlFor="terms" style={{ cursor: 'pointer', fontWeight: 'bold' }}>
                  I agree to the GamePoint Terms and Conditions
                </label>
          ...
          <div style={{ 
            ...
            <h4 style={{ color: '#00ff88', marginBottom: '1rem' }}>🎮 Why Join GamePoint?</h4>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap', marginBottom: '0.5rem' }}>
            <span style={{ color: '#00ff88' }}>🔐 256-bit SSL</span>
            <span style={{ color: '#00ff88' }}>🛡️ Secure Payments</span>
            <span style={{ color: '#00ff88' }}>👑 Trusted by Gamers</span>
          </div>
